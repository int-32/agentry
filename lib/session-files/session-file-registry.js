...
export function sessionFilesCacheDir(agentryHome, sessionPath) {
  if (!agentryHome) throw new Error("agentryHome is required for session file cache");
  ...
  return path.join(agentryHome, "session-files", hash);
}
