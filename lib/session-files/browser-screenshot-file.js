...
export function browserScreenshotPath(agentryHome, sessionPath, { base64, mimeType } = {}) {
  return path.join(
    sessionFilesCacheDir(agentryHome, sessionPath),
...
export async function persistBrowserScreenshotFile({
  ...
  const filePath = browserScreenshotPath(agentryHome, sessionPath, { base64, mimeType });
