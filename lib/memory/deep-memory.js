...
1. 只提取用户画像和粗颗粒近况相关的客观事实。
   ...
   粗颗粒近况包括：用户最近关注的领域/项目/主题，例如"记忆系统""Project Agentry""AI Agent"。
...
1. Extract only objective facts about the user profile and coarse current state.
   ...
   Coarse current state includes the broad domain/project/theme the user is recently focused on, such as "memory systems", "Project Agentry", or "AI Agent".
