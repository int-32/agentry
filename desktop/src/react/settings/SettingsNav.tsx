...
const TAB_ITEMS = [
  ...
  { id: 'projects', key: 'settings.tabs.projects', d: '<path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><path d="M8 13h8"/><path d="M8 16h5"/>' },
...
function buildNavItems(pluginSettingsTabs: PluginSettingsTab[], platformName?: string | null) {
  ...
  const nativeTabs = pluginSettingsTabs
    ...
    .map(tab => ({
      id: tab.id,
      label: tab.nativeComponent === 'mcp.settings' ? t('settings.tabs.mcp') : titleToLabel(tab.title),
