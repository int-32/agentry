...
Then manually open the desktop board tab and verify the board sidebar, project board switching, manual task creation, status movement, detail editing, comments, and board agent selection.
