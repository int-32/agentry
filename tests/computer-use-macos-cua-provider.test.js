...
describe("macos Cua provider", () => {
  ...
  it("prefers a Agentry-bundled Computer Use helper over an external Cua Driver install", () => {
    const command = resolveCuaDriverCommand({
      ...
      existsSync: (p) => p === "/Applications/Agentry.app/Contents/Resources/computer-use/macos/hana-computer-use-helper"
        || p === "/opt/cua-driver",
      homeDir: "/Users/hana",
      arch: "arm64",
    ...
    expect(command).toBe("/Applications/Agentry.app/Contents/Resources/computer-use/macos/hana-computer-use-helper");
  });
